...
const Sidebar = () => {
    return (
        ...
        <div className="sb-sidenav-menu">
            <div className="nav">
                <div className="sb-sidenav-menu-heading">Super adminsuper</div>
                <Link className="nav-link" to="/admin/dashboard">
                    <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>
                    Dashboard
                </Link>
                <div className="sb-sidenav-menu-heading">Slug</div>
                <Link className="nav-link collapsed" to="#" data-bs-toggle="collapse" data-bs-target="#collapseProductsaa" aria-expanded="false" aria-controls="collapseProductsa">
                    <div className="sb-nav-link-icon"><i className="fas fa-columns"></i></div>
                    Slug
                    <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div>
                </Link>
                <div className="collapse" id="collapseProductsaa" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav className="sb-sidenav-menu-nested nav">
                        <Link className="nav-link" to="/admin/slug"> Add Slug</Link>
                        <Link className="nav-link" to="/admin/viewslug"> View Slug</Link>
                    </nav>
                </div>
                <div className="sb-sidenav-menu-heading">Categoory</div>
