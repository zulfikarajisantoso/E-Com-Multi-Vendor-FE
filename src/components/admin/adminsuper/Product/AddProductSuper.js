...
const AddproductSuper = () => {
    ...
    const subproduct = (e) => {
        ...
        axios.post("/api/super-admin/store-product", formdata).then((res) => {
...
export default AddproductSuper;
