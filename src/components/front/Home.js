    ...
    return (
      <div className="col-md-4 bgg" key={idx}>
        <div className="d-flex justify-content-center align-items-center">
          <img
            src={`https://backstoraja.herokuapp.com/${item.image}`}
            alt={item.name}
            className=" h-100 w-100 "
          />
        </div>
        <div
          className="d-flex flex-column  justify-content-end text-dark judulitem"
        ...
        >
          ...
          <p style={{ marginTop: "0px", fontSize: "7px" }}>
            {item.description}
          </p>
          <div
          ...
          >
            ...
            >
              ...
              >
                {" "}
                <MdAddShoppingCart className="ico" />
              </Link>
            </div>
          </div>
        </div>
    ...
    <div>
      <div className="homecon">
        ...
        <div className=" d-flex flex-column justify-content-center align-items-center">
          <h2 className="brand2">Offical Website Of</h2>
          <h1 className="namebrand" data-text="STORAJA">
            STORAJA
          </h1>
          <p className="text-light ket">
            Menjual semua product khas dari Toraja{" "}
          </p>
          <Link
            className=" btn-outline-light btn-lg btn btt rounded-0"
            to="/collection"
          >
            Collection
          </Link>
            ...
            <div className="d-flex flex-column justify-content-center">
              ...
              <div className="hal2 d-flex flex-column  justify-content-center align-items-center text-light">
                ...
                <div className="text-center px-4 fonn">
                  ...
                  tempor ex nec ex convallis, eget dapibus purus volutpat.
                  Vivamus nec porttitor orci, ultricies mattis orci.
                </div>
      ...
      <div>
        ...
        <div className="container d-flex justify-content-center flex-column align-items-center mt-3">
          <h1 className="about" style={{ fontSize: "30px" }}>
            Toraja untuk semua
          </h1>
          <p className="text-center p-1 px-5">
      ...
      <div className="container mt-5">
            ...
            <div className="row ">
              <div className="dip">
                ...
                <div className="icoo ">
                  <a
                    className="gmb "
                    href="https://www.instagram.com/laperrman/"
                  >
                    <BsInstagram />{" "}
                  </a>
                </div>
        ...
        <div className="d-flex justify-content-center align-items-center">
          <div className="bttn">
            <a className="asi" href="https://www.instagram.com/laperrman/">
              Shop From Instagram
            </a>
          </div>
        </div>
